...
const DEFAULT = Object.freeze({
  ...
  layers: Object.freeze({ grid: true, mountains: true, natal: true, annual: false, monthly: false })
});

export function createOverlayState(seed = {}) {
  return { image: { ...DEFAULT.image, ...seed.image }, analysis: { ...DEFAULT.analysis, ...seed.analysis }, layers: { ...DEFAULT.layers, ...seed.layers } };
}
